...
namespace Projectname.ServiceName.Infrastructure.Persistence.Repositories
{
    public class EmployeeRepositoryAsync : GenericRepositoryAsync<Employee>, IEmployeeRepositoryAsync
    {
        ...
        public EmployeeRepositoryAsync(ServiceNameDbContext dbContext,
        ...
        public async Task<(IEnumerable<SerializableEntity> data, RecordsCount recordsCount)> GetPagedEmployeeReponseAsync(GetEmployeesQuery requestParameter)
        {
