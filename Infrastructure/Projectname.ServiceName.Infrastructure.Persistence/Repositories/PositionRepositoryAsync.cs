...
namespace Projectname.ServiceName.Infrastructure.Persistence.Repositories
{
    public class PositionRepositoryAsync : GenericRepositoryAsync<Position>, IPositionRepositoryAsync
    {
        ...
        public PositionRepositoryAsync(ServiceNameDbContext dbContext,
        ...
        public async Task<(IEnumerable<SerializableEntity> data, RecordsCount recordsCount)> GetPagedPositionReponseAsync(GetPositionsQuery requestParameter)
        {
